    ...
    <div className="w-full flex flex-col items-center gap-4 md:gap-6">
      ...
      <div className="relative w-full max-w-xs md:max-w-2xl 2xl:max-w-4xl">
        ...
        <button
          ...
          className="hidden md:block absolute top-2 right-2 bg-primary text-primary-content md:text-base 2xl:text-xl px-3 py-2 rounded-lg shadow-lg hover:bg-primary/90 transition-all z-10"
        >
        ...
        <AnimatePresence>
          {showFeatures && (
            <motion.div
              ...
              className="hidden md:flex absolute top-0 left-0 h-full w-full md:w-1/2 bg-base-200/90 items-center justify-center p-4 rounded-lg backdrop-blur-sm"
            >
              <ul className="list-disc list-outside space-y-2 pl-4 text-xs md:text-sm 2xl:text-lg text-gray-400 w-full max-w-[180px] md:max-w-xs 2xl:max-w-md">
                {features.map((f, i) => (
      ...
      <div className="hidden md:flex gap-4 mt-2 justify-center 2xl:gap-8">
        <a
          href="https://stockmounts.onrender.com"
          target="_blank"
          rel="noopener noreferrer"
          className="btn btn-primary font-semibold px-6 py-2 text-base 2xl:px-8 2xl:text-2xl"
        >
          Website
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="btn btn-secondary font-semibold px-6 py-2 text-base 2xl:px-8 2xl:text-2xl"
        >
          Repo
        </a>
      </div>
