      ...
      <div className="pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base text-gray-300">
              I've built solid programming skills through both coursework and personal projects.
              Machine learning and AI has been an ongoing interest of mine, and I've been learning
              related concepts continuously. Related skills:
            </p>
            <ul className="list-none text-base text-gray-300 pl-8 mb-2 mt-2">
              <li>
